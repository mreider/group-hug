...
* We need to tell Rails to load some Javascript (JQuery in particular) on every page. Go back and edit the @app/viewslayouts/application.html.erb@ and put this up in the header of your HTML document.
