...
* Finally, still the same page, we add some code that will display the default group when the page loads:
	  
p(clues). $('#posts_container').load('/groups/<%=@default_group%>/posts',  function() {
&nbsp;FB.XFBML.parse(document.getElementById('posts_container'));
});

h4. Get Group Messages, and Profile pictures using Mogli
