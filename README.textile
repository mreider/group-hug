...
* *Install rails.* On Windows, you can use the "Rails Installer":http://railsinstaller.org and on OSX or Linux, you can use RVM by entering the following in your terminal:
