...
* Time to deploy! To put this application into production, we need to do a few things. First, you need to sign up for an Engine Yard account. 

p(clues). "Sign up for Engine Yard cloud here":https://login.engineyard.com/signup/from/https://cloud.engineyard.com
