...
* Create config/facebooker.yml with settings from your Facebook application pages. To find your settings, go to "the facebook developer page":http://www.facebook.com/developers/ and click on your application name.
