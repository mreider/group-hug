...
p(codey). rails generate view user login
  
* Open and edit the page you just created ( @app/views/user/login.html.erb@ )
...
* Add methods to ApplicationController ( @app/controllers/application_controller.rb@ ) to check if the user has logged in and determine his/her user id:
